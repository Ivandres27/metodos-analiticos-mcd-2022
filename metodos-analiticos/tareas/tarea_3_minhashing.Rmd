...
**Con palabras similares a la original los números del hash "digest2int" son muy diferentes entre si a pesar de variar en muy pocas letras, incluso un solo espacio produce un hash muy diferente**
...
**Porque solo agrupará a textos que son exactamente iguales, los textos que difieran por cualquier caracter tendrán hashes diferentes**
...
**Porque ambos comparten la misma teja a la cual se le asigno el hash que resulto ser el minimo de todas las tejas de ambos (zan)**

**Si los documentos son muy diferentes entonces tendrán muy pocas tejas en comun lo cual hace que sea muy poco probable que compartan la teja a la cual se le asignará el minhash**
...
**Todos los que comparten un minhash se consideran como candidatos dado que para que esto ocurra es muy probable que se deba a que tienen muchas tejas en común**

**Los falsos positivos se pueden dar debido al azar si coincide que tienen en comun justo la teja a la que se le asigna el minhash y muy pocas en común (no son textos similares)**
...
**Los falsos negativos ocurren cuando en las pocas tejas en las que difieren se encuentra una teja a la cual se le asignará el minhash y por lo tanto no tendrán el mismo minhash y se descartaran como textos candidatos aun que si sean similares**
